...
const Ref1 = () => {
  return (
    ...
    style={{ backgroundImage: `url("/assets/Refrigeration Background.webp")`}}
      // /Users/hargobindsingh/Local Documents/Coding Language/My work/public/assets/images/Refri background.webp
    >
      ...
      <div className="relative z-10 bg-[#f9f9f9] opacity-75 backdrop-blur-md rounded-xl border-2 border-white border-opacity-30 shadow-lg p-8 sm:p-12 lg:p-16 max-w-2xl mx-4 text-center transform transition-all duration-500 hover:scale-105">
        ...
        <p className="text-base sm:text-lg font-semibold lg:text-xl text-black mb-8">
